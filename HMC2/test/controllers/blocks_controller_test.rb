...
class BlocksControllerTest < ActionController::TestCase
  ...
  test "should create block" do
    assert_difference('Block.count') do
      post :create, block: { description: @block.description, head: @block.head, image: @block.image, poll_id: @block.poll_id }
    end
  ...
  test "should update block" do
    patch :update, id: @block, block: { description: @block.description, head: @block.head, image: @block.image, poll_id: @block.poll_id }
    assert_redirected_to block_path(assigns(:block))
  end
